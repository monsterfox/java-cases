	...
	<div class="container ">
		...
		<div class="row">
			<div class="col-xs-4 col-xs-offset-4">
				<h2 style="text-align: center;">添加菜品</h2>
			</div>
		...
		<div class="row">
			<div class="col-xs-12">
				<form action="${pageContext.request.contextPath}/service?action=addFood" method="post" role="form" enctype="multipart/form-data">
					<table class="table table-borderd" align="center" width="500">
						...
						<tr>
							<td>菜品价格：</td>
							<td><input type="text" name="fprice" class="form-control" /></td>
						</tr>
						<tr>
							<td>菜品图片：</td>
							<td>
								<div id="preview">
									<img id="imghead" class="img-thumbnail" src='<%=request.getContextPath()%>/img/default.jpg'>
								</div>
